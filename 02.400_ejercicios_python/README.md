...
### [Funciones](02.funciones)
   **Ejercicios**  
   ...
   - [Ejercicio 16](02.funciones/16.ejercicio.py)
     - Crear una función que calcule la temperatura media de un día a partir de la temperatura máxima y mínima.
        - Crear un programa principal que utilice la función anterior y vaya pidiendo la temperatura máxima y mínima de cada día y mostrando la media.
